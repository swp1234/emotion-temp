...
const RESULTS = [
    {
        ...
        compat: "따뜻한 봄날 (25~30°C) - 당신의 냉정함을 녹여줄 따뜻한 사람",
    ...
    },
    {
        ...
        desc: "잔잔한 빗소리처럼 조용하지만 깊은 감수성을 가졌습니다. 혼자만의 시간을 사랑하면서도 따뜻한 마음을 지녔습니다.",
    ...
    },
    {
        ...
        title: "포근한 봄 햇살",
        subtitle: "따뜻하고 배려심 깊은 당신",
        color: "#e07a5f", colorEnd: "#8c3e2a",
        desc: "봄 햇살처럼 따뜻한 당신은 주변 사람들에게 안정감을 줍니다. 공감 능력이 뛰어나고 배려심이 깊습니다.",
        traits: ["감정 표현: 자연스럽고 따뜻함", "타인 공감: 80%", "에너지원: 좋은 사람들과의 시간", "대인관계: 모두에게 편안한 존재"],
        activities: ["친구들과 소소한 모임", "봉사활동", "원예/꽃 가꾸기", "편지 쓰기"],
        warnings: ["남의 감정에 너무 많이 휘둘리지 마세요", "자신의 감정도 중요하게 챙기세요"],
        compat: "선선한 바람 (5~10°C) - 당신의 따뜻함에 안정을 더해주는 사람"
    },
    {
